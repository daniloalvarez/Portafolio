 ...
 */
public class ServletEscuelaInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            request.getRequestDispatcher("CrearEscuela.jsp").forward(request, response);
        ...
        if(request.getMethod().equals("POST"))
        {
           ...
           boolean retorno = dalEscuela.insert();

    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getMethod().equals("POST")) {
                ...
                for(Login e : miLogin.getAll()) {
                    if (e.getRutusuario() == rut) {
                        if (e.getClave().equals(pass)) {
                            HttpSession miSesion = request.getSession();
                            miSesion.setAttribute("miListaSesion", e.getRutusuario());
                            miSesion.setAttribute("tipo", e.getIdTipousuario());

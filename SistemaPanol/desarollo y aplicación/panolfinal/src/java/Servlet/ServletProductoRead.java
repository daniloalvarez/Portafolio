 ...
 * @author Usuario
 */
@WebServlet(name = "ServletProductoRead", urlPatterns = {"/ServletProductoRead"})
public class ServletProductoRead extends HttpServlet {
    ...
    {
        out.print(e.getMessage()+"Error al Guardar Producto");
    }
    }
